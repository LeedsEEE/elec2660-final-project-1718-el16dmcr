...
#import "FlipRetentionWinDraw.h"

@implementation FlipRetentionWinDraw

UIColor *RGB11(float r, float g, float b)           //adapted from https://stackoverflow.com/questions/13224206/how-do-i-create-a-uicolor-from-rgba
{
...
- (void)drawRect:(CGRect)rect {
    ...
    CGColorRef flipRetentionGreen = [RGB11(3, 196, 132) CGColor];
